...
?>
	...
	<div id="content">
		...
		<div class="slots">
			<form action="<?= ABSURL . 'web/admin/editslots.php?id=' . $_GET['id'] ?>" method="post">
								...
								<tbody>
									...
									<tr>
										...
										<td style="padding:3px 6px; text-align:right; border-bottom:1px solid #eee;">
											<input type="number" step="0.01" min="0" name="res_prices[<?=$slot['res_id']?>][<?=$r['id']?>]" value="<?=number_format($r['price'],2,'.','')?>" class="svc-price" style="width:90px; text-align:right;" />
										</td>
									</tr>
									<?php } ?>
								</tbody>
				...
				<input type="hidden" name="save_res_prices" value="1" />
