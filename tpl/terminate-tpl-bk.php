						...
						?>
							<div class="form-check">
								<label class="<?=$class1?>" for="time_<?=$time["id"]?>">
									...
									<span class="<?=$class2?>"><?=$time["time_start"]?> - <?=$time["time_end"]?></span>
								</label>
							</div>
                ...
                <div class="fRight registerMe">
					<h3>Ihre Buchung:</h3>
						...
						<div class="form-group text-left times_info_block">
							...
							<div class="text-danger" style="display: none;">Sie können nicht mehr als <?= count($reservations_times) ?> auswählen.</div>
						</div>

						<div class="form-group text-right">
							<button class="btn btn-warning" type="submit">Anwenden</button>
						</div>
